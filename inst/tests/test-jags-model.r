...
test_that("jags_model returns object of correct class", {
  ...
  expect_true(identical(select_aggregation(model3), select_aggregation(model)))
  expect_true(identical(select_derived(model3), select_derived(model)))
  ...
  expect_true(identical(select_aggregation(model2), select_aggregation(model)))
