context("is_data_list")

test_that("is_data_list returns TRUE", {
  
  data <- list(x = 1)
  expect_that(is_data_list(data), equals(TRUE))
...
test_that("is_data_list returns FALSE", {

  data <- 1
  expect_that(is_data_list(data), equals(FALSE))
