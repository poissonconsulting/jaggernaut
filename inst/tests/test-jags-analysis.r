...
test_that("checks input", {
   ...
   expect_that(jags_analysis (model, data), is_a("jags_analysis"))
   ...
   expect_that(jags_analysis (model, data, niter = 100), is_a("jags_analysis"))
   expect_that(jags_analysis (model, data, niter = 100.1), is_a("jags_analysis"))
