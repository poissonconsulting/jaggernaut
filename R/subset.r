...
subset.mcarray <- function (object, sim = NULL, chain = NULL, ...) {
...
subset_mcarray <- function (object, sim = NULL, chain = NULL, ...) {
  stopifnot(is.mcarray(object))
  return (subset(object, sim = sim, chain = chain, ...))
}

subset.jagr_chains <- function (object, sim = NULL, chain = NULL) {
  
  samples(object) <- lapply(samples(object), FUN = subset_mcarray, sim=sim, chain=chain)
...
#' @export 
subset.jags_model <- function (object, model_number, ...) {   
...
#' @export 
subset.jags_analysis <- function (object, model_number = NULL, ...) {   
...
#' @export 
subset.jags_simulation <- function (object, value = NULL, rep = NULL, ...) {   
...
subset.jags_power_analysis <- function (object, model_number = NULL, value = NULL, rep = NULL, ...) {
